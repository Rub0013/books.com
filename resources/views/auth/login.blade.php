                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url(App::getLocale().'/login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-primary" href="{{ route('facebook.login', array('local' => App::getLocale())) }}">Facebook login</a>
                                <a class="btn btn-danger" href="{{ route('google.login', array('local' => App::getLocale())) }}">Google login</a>
